/**
 * SVG icon library — replaces all emoji usage with clean, minimal SVG icons.
 * Apple-style: thin strokes, rounded caps, simple geometry.
 */
...
export function IconMonitor({ className, size = 24 }: IconProps) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
